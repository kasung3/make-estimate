...
/* harmony import */ var _home_ubuntu_make_estimate_nextjs_space_app_api_admin_check_route_ts__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./app/api/admin/check/route.ts */ "(rsc)/./app/api/admin/check/route.ts");
...
const routeModule = new next_dist_server_future_route_modules_app_route_module_compiled__WEBPACK_IMPORTED_MODULE_0__.AppRouteRouteModule({
    ...
    resolvedPagePath: "/home/ubuntu/make_estimate/nextjs_space/app/api/admin/check/route.ts",
    nextConfigOutput,
    userland: _home_ubuntu_make_estimate_nextjs_space_app_api_admin_check_route_ts__WEBPACK_IMPORTED_MODULE_3__
});
...
/***/ "(rsc)/./app/api/admin/check/route.ts":
/*!**************************************!*\
...
async function GET() {
    try {
        ...
        return next_server__WEBPACK_IMPORTED_MODULE_0__.NextResponse.json({
            isAdmin: (0,_lib_billing__WEBPACK_IMPORTED_MODULE_3__.isPlatformAdmin)(session.user.email)
        });
    } catch  {
        return next_server__WEBPACK_IMPORTED_MODULE_0__.NextResponse.json({
            isAdmin: false
