...
(() => {
var exports = {};
exports.id = "app/api/admin/companies/route";
exports.ids = ["app/api/admin/companies/route"];
exports.modules = {
...
/* harmony import */ var _home_ubuntu_make_estimate_nextjs_space_app_api_admin_companies_route_ts__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./app/api/admin/companies/route.ts */ "(rsc)/./app/api/admin/companies/route.ts");
...
const routeModule = new next_dist_server_future_route_modules_app_route_module_compiled__WEBPACK_IMPORTED_MODULE_0__.AppRouteRouteModule({
    definition: {
        ...
        page: "/api/admin/companies/route",
        pathname: "/api/admin/companies",
        filename: "route",
        bundlePath: "app/api/admin/companies/route"
    },
    resolvedPagePath: "/home/ubuntu/make_estimate/nextjs_space/app/api/admin/companies/route.ts",
    nextConfigOutput,
    userland: _home_ubuntu_make_estimate_nextjs_space_app_api_admin_companies_route_ts__WEBPACK_IMPORTED_MODULE_3__
});
// Pull out the exports that we need to expose from the module. This should
// be eliminated when we've moved the other routes to the new format. These
// are used to hook into the route.
const { requestAsyncStorage, staticGenerationAsyncStorage, serverHooks } = routeModule;
const originalPathname = "/api/admin/companies/route";
function patchFetch() {
...
/***/ "(rsc)/./app/api/admin/companies/route.ts":
/*!******************************************!*\
...
async function GET(request) {
    try {
        ...
        const [companies, totalCount] = await Promise.all([
            _lib_db__WEBPACK_IMPORTED_MODULE_3__.prisma.company.findMany({
                where,
                include: {
                    billing: {
                        select: {
            ...
            _lib_db__WEBPACK_IMPORTED_MODULE_3__.prisma.company.count({
                where
            })
        ]);
