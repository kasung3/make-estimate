...
function RegisterForm() {
  ...
  if (status === 'loading' || checkoutLoading) {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-cyan-50 to-teal-50">
    ...
    <div className="min-h-screen bg-gradient-to-br from-cyan-50 to-teal-50">
      ...
      <div className="pt-24 pb-12 px-4 flex items-center justify-center">
        <div className="w-full max-w-lg space-y-6">
          ...
          {planInfo && (
            <Card className="border-2 border-cyan-200 bg-gradient-to-br from-cyan-50/50 to-teal-50/50">
              <CardContent className="p-4">
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex-1">
                    <p className="font-semibold text-gray-900">Selected Plan: {planInfo.name}</p>
