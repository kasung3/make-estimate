...
(() => {
var exports = {};
exports.id = "app/api/billing/plans/route";
exports.ids = ["app/api/billing/plans/route"];
exports.modules = {
...
/* harmony import */ var _home_ubuntu_make_estimate_nextjs_space_app_api_billing_plans_route_ts__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./app/api/billing/plans/route.ts */ "(rsc)/./app/api/billing/plans/route.ts");
...
const routeModule = new next_dist_server_future_route_modules_app_route_module_compiled__WEBPACK_IMPORTED_MODULE_0__.AppRouteRouteModule({
    definition: {
        ...
        page: "/api/billing/plans/route",
        pathname: "/api/billing/plans",
        filename: "route",
        bundlePath: "app/api/billing/plans/route"
    },
    resolvedPagePath: "/home/ubuntu/make_estimate/nextjs_space/app/api/billing/plans/route.ts",
    nextConfigOutput,
    userland: _home_ubuntu_make_estimate_nextjs_space_app_api_billing_plans_route_ts__WEBPACK_IMPORTED_MODULE_3__
});
// Pull out the exports that we need to expose from the module. This should
// be eliminated when we've moved the other routes to the new format. These
// are used to hook into the route.
const { requestAsyncStorage, staticGenerationAsyncStorage, serverHooks } = routeModule;
const originalPathname = "/api/billing/plans/route";
function patchFetch() {
...
/***/ "(rsc)/./app/api/billing/plans/route.ts":
/*!****************************************!*\
...
/* harmony import */ var _lib_billing__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @/lib/billing */ "(rsc)/./lib/billing.ts");
...
async function GET() {
    try {
        const plans = await (0,_lib_billing__WEBPACK_IMPORTED_MODULE_1__.getActivePlans)();
        ...
        return next_server__WEBPACK_IMPORTED_MODULE_0__.NextResponse.json(planInfos);
    } catch (error) {
...
var __webpack_exports__ = __webpack_require__.X(0, ["vendor-chunks/next","vendor-chunks/date-fns"], () => (__webpack_exec__("(rsc)/../../../../opt/hostedapp/node/root/app/node_modules/next/dist/build/webpack/loaders/next-app-loader.js?name=app%2Fapi%2Fbilling%2Fplans%2Froute&page=%2Fapi%2Fbilling%2Fplans%2Froute&appPaths=&pagePath=private-next-app-dir%2Fapi%2Fbilling%2Fplans%2Froute.ts&appDir=%2Fhome%2Fubuntu%2Fmake_estimate%2Fnextjs_space%2Fapp&pageExtensions=tsx&pageExtensions=ts&pageExtensions=jsx&pageExtensions=js&rootDir=%2Fhome%2Fubuntu%2Fmake_estimate%2Fnextjs_space&isDev=true&tsconfigPath=tsconfig.json&basePath=&assetPrefix=&nextConfigOutput=&preferredRegion=&middlewareConfig=e30%3D!")));
