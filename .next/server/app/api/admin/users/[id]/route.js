...
/* harmony import */ var _home_ubuntu_make_estimate_nextjs_space_app_api_admin_users_id_route_ts__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./app/api/admin/users/[id]/route.ts */ "(rsc)/./app/api/admin/users/[id]/route.ts");
...
const routeModule = new next_dist_server_future_route_modules_app_route_module_compiled__WEBPACK_IMPORTED_MODULE_0__.AppRouteRouteModule({
    ...
    resolvedPagePath: "/home/ubuntu/make_estimate/nextjs_space/app/api/admin/users/[id]/route.ts",
    nextConfigOutput,
    userland: _home_ubuntu_make_estimate_nextjs_space_app_api_admin_users_id_route_ts__WEBPACK_IMPORTED_MODULE_3__
});
...
async function DELETE(request, { params }) {
    try {
        ...
        await _lib_db__WEBPACK_IMPORTED_MODULE_3__.prisma.$transaction([
            // Update user: set deletedAt, block access
            _lib_db__WEBPACK_IMPORTED_MODULE_3__.prisma.user.update({
                where: {
                    id
                },
                data: {
            ...
            _lib_db__WEBPACK_IMPORTED_MODULE_3__.prisma.companyMembership.updateMany({
                where: {
                    userId: id
                },
                data: {
        ...
        return next_server__WEBPACK_IMPORTED_MODULE_0__.NextResponse.json({
            user: {
                ...
                fullName: [
                    user.firstName,
                    user.lastName
                ].filter(Boolean).join(" ") || user.name || null,
                phone: user.phone,
