...
/* harmony import */ var _home_ubuntu_make_estimate_nextjs_space_app_api_admin_users_route_ts__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./app/api/admin/users/route.ts */ "(rsc)/./app/api/admin/users/route.ts");
...
const routeModule = new next_dist_server_future_route_modules_app_route_module_compiled__WEBPACK_IMPORTED_MODULE_0__.AppRouteRouteModule({
    ...
    resolvedPagePath: "/home/ubuntu/make_estimate/nextjs_space/app/api/admin/users/route.ts",
    nextConfigOutput,
    userland: _home_ubuntu_make_estimate_nextjs_space_app_api_admin_users_route_ts__WEBPACK_IMPORTED_MODULE_3__
});
...
async function GET(request) {
    try {
        ...
        const [users, totalCount] = await Promise.all([
            _lib_db__WEBPACK_IMPORTED_MODULE_3__.prisma.user.findMany({
                where,
                include: {
                    memberships: {
                        include: {
            ...
            _lib_db__WEBPACK_IMPORTED_MODULE_3__.prisma.user.count({
                where
            })
        ]);
