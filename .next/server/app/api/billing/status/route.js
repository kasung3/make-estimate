...
(() => {
var exports = {};
exports.id = "app/api/billing/status/route";
exports.ids = ["app/api/billing/status/route"];
exports.modules = {
...
/* harmony import */ var _home_ubuntu_make_estimate_nextjs_space_app_api_billing_status_route_ts__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./app/api/billing/status/route.ts */ "(rsc)/./app/api/billing/status/route.ts");
...
const routeModule = new next_dist_server_future_route_modules_app_route_module_compiled__WEBPACK_IMPORTED_MODULE_0__.AppRouteRouteModule({
    definition: {
        ...
        page: "/api/billing/status/route",
        pathname: "/api/billing/status",
        filename: "route",
        bundlePath: "app/api/billing/status/route"
    },
    resolvedPagePath: "/home/ubuntu/make_estimate/nextjs_space/app/api/billing/status/route.ts",
    nextConfigOutput,
    userland: _home_ubuntu_make_estimate_nextjs_space_app_api_billing_status_route_ts__WEBPACK_IMPORTED_MODULE_3__
});
// Pull out the exports that we need to expose from the module. This should
// be eliminated when we've moved the other routes to the new format. These
// are used to hook into the route.
const { requestAsyncStorage, staticGenerationAsyncStorage, serverHooks } = routeModule;
const originalPathname = "/api/billing/status/route";
function patchFetch() {
...
/***/ "(rsc)/./app/api/billing/status/route.ts":
/*!*****************************************!*\
...
/* harmony import */ var _lib_billing__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @/lib/billing */ "(rsc)/./lib/billing.ts");
...
async function GET() {
    try {
        ...
        const [user, company, membership, activePlans] = await Promise.all([
            _lib_db__WEBPACK_IMPORTED_MODULE_4__.prisma.user.findUnique({
                where: {
                    id: userId
                },
                select: {
            ...
            _lib_db__WEBPACK_IMPORTED_MODULE_4__.prisma.companyMembership.findFirst({
                where: {
                    userId,
                    companyId
                }
            }),
            (0,_lib_billing__WEBPACK_IMPORTED_MODULE_3__.getActivePlans)()
        ]);
        ...
        const billingStatus = await (0,_lib_billing__WEBPACK_IMPORTED_MODULE_3__.getCompanyBillingStatus)(companyId);
        // Get current plan info from DB
        let planInfo = null;
        if (billingStatus.planKey) {
            const plan = await (0,_lib_billing__WEBPACK_IMPORTED_MODULE_3__.getPlanFromDb)(billingStatus.planKey);
            if (plan) {
                planInfo = {
                    id: plan.id,
