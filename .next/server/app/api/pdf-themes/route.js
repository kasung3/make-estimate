...
(() => {
var exports = {};
exports.id = "app/api/pdf-themes/route";
exports.ids = ["app/api/pdf-themes/route"];
exports.modules = {
...
/* harmony import */ var _home_ubuntu_make_estimate_nextjs_space_app_api_pdf_themes_route_ts__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./app/api/pdf-themes/route.ts */ "(rsc)/./app/api/pdf-themes/route.ts");
...
const routeModule = new next_dist_server_future_route_modules_app_route_module_compiled__WEBPACK_IMPORTED_MODULE_0__.AppRouteRouteModule({
    definition: {
        ...
        page: "/api/pdf-themes/route",
        pathname: "/api/pdf-themes",
        filename: "route",
        bundlePath: "app/api/pdf-themes/route"
    },
    resolvedPagePath: "/home/ubuntu/make_estimate/nextjs_space/app/api/pdf-themes/route.ts",
    nextConfigOutput,
    userland: _home_ubuntu_make_estimate_nextjs_space_app_api_pdf_themes_route_ts__WEBPACK_IMPORTED_MODULE_3__
});
// Pull out the exports that we need to expose from the module. This should
// be eliminated when we've moved the other routes to the new format. These
// are used to hook into the route.
const { requestAsyncStorage, staticGenerationAsyncStorage, serverHooks } = routeModule;
const originalPathname = "/api/pdf-themes/route";
function patchFetch() {
...
/***/ "(rsc)/./app/api/pdf-themes/route.ts":
/*!*************************************!*\
  !*** ./app/api/pdf-themes/route.ts ***!
  \*************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
async function GET() {
    try {
        ...
        const themes = await _lib_db__WEBPACK_IMPORTED_MODULE_3__.prisma.pdfTheme.findMany({
            where: {
                companyId
            },
            orderBy: [
        ...
        return next_server__WEBPACK_IMPORTED_MODULE_0__.NextResponse.json(themes);
    } catch (error) {
...
async function POST(request) {
    try {
        ...
        const existingThemes = await _lib_db__WEBPACK_IMPORTED_MODULE_3__.prisma.pdfTheme.count({
            where: {
                companyId
            }
        });
        ...
        if (isDefault) {
            await _lib_db__WEBPACK_IMPORTED_MODULE_3__.prisma.pdfTheme.updateMany({
                where: {
                    companyId,
                    isDefault: true
                },
        ...
        const theme = await _lib_db__WEBPACK_IMPORTED_MODULE_3__.prisma.pdfTheme.create({
            data: {
                companyId,
        ...
        return next_server__WEBPACK_IMPORTED_MODULE_0__.NextResponse.json(theme);
    } catch (error) {
